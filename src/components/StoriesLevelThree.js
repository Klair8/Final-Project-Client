    ...
    useEffect(()=>{
      const getStories = async ()=>{
        try{
            ...
            const specificStories = data.filter(story => story.level == "level3" )
        setStories(specificStories);
         console.log('datalevel3',specificStories)
        } catch(e){
            console.log(e)
        }
      }
...
export default StoriesLevelThree